...
def stacked_LSTM2(history_points):
    ...
    x = LSTM(128, name='lstm_0', return_sequences=True)(lstm_input)
    x = Dropout(0.2, name='lstm_dropout_0')(x)
    x = LSTM(128, name='lstm_1', return_sequences=True)(x)
    x = Dropout(0.2, name='lstm_dropout_1')(x)
    x = LSTM(128, name='lstm_2')(x)
    x = Dropout(0.2, name='lstm_dropout_2')(x)
    lstm_branch = Model(inputs=lstm_input, outputs=x)
    ...
    y = Activation("relu", name='tech_relu_0')(y)
    y = Dropout(0.2, name='tech_dropout_0')(y)
    y = Dense(128, name='tech_dense_1')(y)
    y = Activation("relu", name='tech_relu_1')(y)
    y = Dropout(0.2, name='tech_dropout_1')(y)
    y = Dense(128, name='tech_dense_2')(y)
    y = Activation("relu", name='tech_relu_2')(y)
    y = Dropout(0.2, name='tech_dropout_2')(y)
    technical_indicators_branch = Model(inputs=dense_input, outputs=y)
